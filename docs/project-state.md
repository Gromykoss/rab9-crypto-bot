...
- Improved `/testsignal` button UX with an in-memory pending-address flow; invalid follow-up text keeps pending mode active, and normal Solana addresses no longer show the legacy inline action menu.
