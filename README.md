...
- `/pairmakers PAIR deep50` - manually discover top maker wallets in Birdeye pair trades. `deep` scans up to 20 pages and `deep50` up to 50 pages with safe delays, then ranks makers by trade count. Discovery tool only; no PnL or trading advice.
