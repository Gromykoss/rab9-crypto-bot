...
- `/tokenflow solana ADDRESS 7d` - manually check Arkham top token flow for a token contract and enrich the first 5 flow addresses with Arkham wallet intelligence. Period is optional; default is `24h`.
